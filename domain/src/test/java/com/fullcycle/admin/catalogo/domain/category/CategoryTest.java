...
public class CategoryTest extends UnitTest {
    ...
    @Test
    public void givenValidParam_whenCallNewCategory_thenInstantiatecategory() {

        final var expectedName = "Filmes";
        final var expectedDescription = "Categoria do filme";
    ...
    public void givenAnInvalidNameLengthLessThan3_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        ...
        final var expectedName = "Jo ";
        final var expectedDescription = "";
        final var expectedIsActive = true;
        final var expectedErrorMessage = "'name' must be between 3 and 255 characters not be empty";
        final var expectedErrorCount = 1;
