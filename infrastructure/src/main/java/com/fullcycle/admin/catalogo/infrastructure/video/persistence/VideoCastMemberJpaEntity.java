...
public class VideoCastMemberJpaEntity {
  ...
  @EmbeddedId private VideoCastMemberID id;
  ...
  public static VideoCastMemberJpaEntity from(
      final VideoJpaEntity entity, final CastMemberID castMemberID) {
    return new VideoCastMemberJpaEntity(
        VideoCastMemberID.from(entity.getId(), castMemberID.getValue()), entity);
  }
