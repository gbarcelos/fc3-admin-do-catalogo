...
/**
 * Creates proxy around each class annotated with @{@link
 * org.springframework.amqp.rabbit.annotation.RabbitListener} that can be used to verify incoming
 * messages via {@link org.springframework.amqp.rabbit.test.RabbitListenerTestHarness}.
 */
@Configuration
