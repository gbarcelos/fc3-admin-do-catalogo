...
class DefaultVideoGatewayTest {
  ...
  @Autowired private DefaultVideoGateway videoGateway;

  @Autowired private CastMemberGateway castMemberGateway;

  @Autowired private CategoryGateway categoryGateway;

  @Autowired private GenreGateway genreGateway;
  ...
  public void givenAValidCategory_whenCallFindAll_shouldReturnFilteredList() {
    ...
    Assertions.assertEquals(
        "21.1 Implementação dos testes integrados do findAll", actualPage.items().get(0).title());
  ...
  public void givenAValidCastMember_whenCallFindAll_shouldReturnFilteredList() {
    ...
    Assertions.assertEquals(
        "System Design no Mercado Livre na prática", actualPage.items().get(1).title());
  }
