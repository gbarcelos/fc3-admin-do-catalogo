...
public class ListVideoUseCaseTest extends UseCaseTest {
  ...
  @InjectMocks private DefaultListVideosUseCase useCase;
  ...
  public void givenAValidQuery_whenCallsListVideos_shouldReturnVideos() {
    ...
    final var expectedPagination =
        new Pagination<>(expectedPage, expectedPerPage, expectedTotal, videos);
  ...
  @Test
  public void
      givenAValidQuery_whenCallsListVideosAndGatewayThrowsRandomError_shouldReturnException() {
    // given
    final var expectedPage = 0;
    final var expectedPerPage = 10;
    final var expectedTerms = "A";
