...
public class CreateGenreUseCaseTest extends UseCaseTest {
  ...
  @InjectMocks private DefaultCreateGenreUseCase useCase;
  ...
  @Test
  public void givenAValidCommandWithNullCategoryList_whenCallsCreateGenre_shouldReturnGenreId() {
    // given
    final var expectName = "Ação";
    final var expectedIsActive = true;

    final var aCommand = CreateGenreCommand.with(expectName, expectedIsActive, null);
    ...
    Mockito.verify(categoryGateway, never()).existsByIds(any());
  ...
  public void givenAInvalidEmptyName_whenCallsCreateGenre_shouldReturnDomainException() {
    ...
    Mockito.verify(categoryGateway, never()).existsByIds(any());
    Mockito.verify(genreGateway, never()).create(any());
  }
  ...
  @Test
  public void
      givenAValidCommand_whenCallsCreateGenreAndSomeCategoriesDoesNotExists_shouldReturnDomainException() {
    // given
