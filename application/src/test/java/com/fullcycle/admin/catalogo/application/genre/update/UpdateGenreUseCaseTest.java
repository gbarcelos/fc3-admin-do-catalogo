...
public class UpdateGenreUseCaseTest extends UseCaseTest {
  ...
  @InjectMocks private DefaultUpdateGenreUseCase useCase;
  ...
  public void givenAValidCommand_whenCallsUpdateGenre_shouldReturnGenreId()
    ...
    final var aCommand =
        UpdateGenreCommand.with(
            expectedId.getValue(), expectedName, expectedIsActive, asString(expectedCategories));
  ...
  public void givenAnInvalidName_whenCallsUpdateGenre_shouldReturnNotificationException() {
    ...
    Mockito.verify(genreGateway, never()).update(any());
  }

  @Test
  public void
      givenAnInvalidName_whenCallsUpdateGenreAndSomeCategoriesDoesNotExists_shouldReturnNotificationException() {
    // given
